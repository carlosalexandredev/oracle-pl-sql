...
BEGIN
/*
The computed salary limit begins at $50,000 but other exceptions need to be identified.
*/
     salary_limit := 50000;

/*
If the database indicates that the employee is a department manager then their salary limit is increased by $1000.
*/
...
/*
If the database indicates the employee has worked on projects then their salary limit increases by $2000 per project.
*/
     SELECT count(*)
     INTO count_projects
     FROM works_on
...
/*
Finally if the employee has dependents then their salary limit increases by $3000 per dependent.
*/
     SELECT count(*)
